...
class PeopelReportHistoryView extends Component {
  ...
  componentDidMount(){
    ...
    InteractionManager.runAfterInteractions(() => {
      this.props.dispatch( create_service(Contract.POST_GET_REPORT_SUPERVISE_HISTORY, {}))
        .then( res => {
          if(res){
            let data = [];
  ...
  _goDetail(item, index){
    Actions.peopelReportHistoryDetail({record:item});
  }
...
const ExportView = connect()(PeopelReportHistoryView);

module.exports.PeopelReportHistoryView = ExportView
