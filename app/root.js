        ...
        <Router createReducer={routerReducerCreate} getSceneStyle={getSceneStyle}>
          <Scene key="modal" component={Modal}>
            <Scene key="root" navigationBarStyle={styles.navigationBarStyle} titleStyle={styles.titleStyle} leftButtonStyle={styles.leftButtonStyle} leftButtonIconStyle={styles.backButtonImage} backButtonImage={backIcon} backButtonTextStyle={styles.backButtonTextStyle} rightButtonTextStyle={styles.rightButtonTextStyle} hideTabBar backTitle='返回'>
              ...
              <Scene key="apCertificateApplySubmit" component={Scenes.APCertificateApplySubmitView} title='新机场证件申请' hideNavBar={false} backTitle='返回' panHandlers={null}/>
              ...
              <Scene key="svoFireCheckInTempletWeb" component={Scenes.SVOFireCheckInTempletWebView} title='消防检查' hideNavBar={false} backTitle='返回' panHandlers={null}/>
              ...
              <Scene key="peopelReportPosting" component={Scenes.PeopelReportPostingView} title='社会监督' hideNavBar={false} backTitle='返回' panHandlers={null}/>
              <Scene key="peopelReportHistory" component={Scenes.PeopelReportHistoryView} title='社会监督历史记录' hideNavBar={false} backTitle='返回' panHandlers={null}/>
              <Scene key="peopelReportHistoryDetail" component={Scenes.PeopelReportHistoryDetailView} title='社会监督详情' hideNavBar={false} backTitle='返回' panHandlers={null}/>
            ...
            <Scene key="datePicker2" component={Components.DatePicker2} />
