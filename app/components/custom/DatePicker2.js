...
class DatePicker2 extends React.Component {
  ...
  render(){
    let { offset, yearSelectIndx, monthSelectIndex, daySelectIndex, monthArray, dayArray } = this.state;
  ...
  _confirm(){
    ...
    if(this.props.modalCallback) this.props.modalCallback(`${year}-${month}`);
  }
...
module.exports.DatePicker2 = DatePicker2;
